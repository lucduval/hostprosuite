    ...
    <header
      className={cn(
        ...
        transparent
          ...
          : "border-b border-border/40 bg-background/90 backdrop-blur-lg shadow-sm"
      )}
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          {navLinks.map((link) => (
            <Link
              ...
              className={cn(
                ...
                transparent
                  ? pathname === link.href
                    ? "text-white underline underline-offset-[20px] decoration-2 decoration-accent-orange"
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <Button
            asChild
            className="bg-accent-orange hover:bg-accent-orange-dark text-white"
          >
